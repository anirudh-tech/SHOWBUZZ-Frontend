...
function UserSignupForm() {
  ...
  return (
    <>
      <section className='bg-gray-950 w-full h-screen  justify-center items-center' style={{ backgroundImage: `url(${loginImage})`, backgroundSize: 'cover' }}>
        <div>
          <h1 className='font-bebas-neue text-5xl font-medium text-primary top-5 left-6'>SHOWBUZZ</h1>
        </div>
        <div className='flex justify-center'> 
          <div className='bg-black bg-opacity-50 border-white border-solid outline-8 p-8 rounded-xl shadow-md md:w-2/3 lg:w-1/3'>
            {isOTP ? (
